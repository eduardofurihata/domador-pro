...
| Item | Detalhe |
|------|---------|
| **Lançamento (Anual)** | **R$ 497/ano** (equivale a R$ 41/mês) |
| **Pós-Lançamento (Anual)** | **R$ 597/ano** (equivale a R$ 50/mês) |
| **Mensal** | **R$ 69/mês** |
| Economia no anual | R$ 231/ano (28% desconto vs mensal) |
| Micro-ancoragem | R$ 2,30/dia (mensal) / R$ 1,63/dia (anual) |
| Meta 1M/ano | ~1.200 assinantes |
| Checkout | Eduzz |
...
```
[DOMA PRO R$ 497/ano lançamento → R$ 597/ano ou R$ 69/mês] - Fase inicial
        ↓
   Assinante engajado
        ↓
   Próximos produtos:
   • Cursos de parceiros (comissão 50%)
   • Trilhas avançadas (outros temas)
   • Experiências presenciais
   • Mentorias em grupo
   • Certificação de Domador
   • Desconto na loja de produtos (futuro)
   • Mercado internacional
```

### Cursos de Parceiros
A plataforma também hospedará cursos de especialistas parceiros.

| Item | Detalhe |
|------|---------|
| **Comissão** | 50% parceiro / 50% plataforma |
| **Tipos de parceiros** | Veterinários, nutricionistas equinos, ferradores, treinadores |
| **Benefício** | Catálogo maior sem custo de produção próprio |
...
### 📜 Certificação de Domador
Ao completar a trilha, o membro recebe a **Certificação de Domador pelo Método André Pedroso**.
- Prova social para o mercado
- Diferencial profissional
- Reconhecimento oficial do método
...
| Cursos de parceiros (veterinários, nutricionistas, ferradores...) | R$ 497 |
| 🔜 Desconto na loja de produtos (futuro) | - |
| **Valor total** | **R$ 3.382** |
...
| | |
|--|--|
| ~~De R$ 3.382/ano~~ | Ancoragem |
| **R$ 497/ano** | Preço de lançamento |
| **R$ 41/mês** | Equivalente mensal |
| **R$ 1,36/dia** | Menos que um café |
...
| | |
|--|--|
| **R$ 597/ano** | Plano anual (28% desconto) |
| **R$ 69/mês** | Plano mensal |
| **R$ 2,30/dia** | Menos que um café |

> **Economia de R$ 231/ano** escolhendo o plano anual vs mensal.
...
| **Conceito** | Assinatura com grupo WhatsApp + vídeos novos + acesso ao André Pedroso |
| **Preço lançamento** | R$ 497/ano (fundadores) |
| **Preço regular anual** | R$ 597/ano (28% desconto) |
| **Preço mensal** | R$ 69/mês |
| **Checkout** | Eduzz |
| **Área de membros** | Astron Members |
| **Principal** | Grupo WhatsApp com André Pedroso + 3 vídeos/semana + lives só pra assinantes |
| **Incluído** | Trilhas de aprendizado + Certificação de Domador + Cursos de parceiros |
| **Cursos parceiros** | Comissão 50/50 |
| **Futuro** | Desconto na loja de produtos |
| **Cancelamento** | A qualquer momento, acesso até o fim do ciclo |
| **Meta inicial** | ~1.200 assinantes = R$ 1M/ano |
